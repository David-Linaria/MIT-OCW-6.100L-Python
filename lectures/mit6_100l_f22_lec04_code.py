...
for i in range(5):
    if i % 2 == 0:
        counter += 1
print(f'there are {counter} even numbers in that range.')
...
index = 0
for char in s:
    if char in s[0:index:1]:
        count += 0
    else:
        count += 1
    index += 1
print(f'\nThere are {count} unique letters in the string.')
################################ ##############
s = 'aabcd'
seen = ''
for char in s:
    if char not in seen:
        seen += char
print(f'There are {len(seen)} unique letters in the string.')
...
for x in range(0,11,1):
    if x == secret:
        ...
        break
if x >= 11:
    print(f'we do not find the secret number.')
...
index1 = index2 = ''
for i in text1:
    if i not in index1 and i not in ' ':
        index1 += i
for j in text2:
    if j not in index2 and j not in ' ':
        index2 += j
for c in index1:
    if c in index2:
        count += 1
print(f'There are {count} common unique characters between the two strings.')
...
index = ''
for i in text1:
    if i in text2 and i not in index:
        index += i
        count += 1
print(f'There are {count} common unique characters between the two strings.')
####################################################
