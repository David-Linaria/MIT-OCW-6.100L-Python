...
# in Python, when assigning an old list to a new variable, the two names point at the same memory location.
# if forgotten, we can always use 'is' to know if lista and listb points at the same location.
# remember, 'a is b' is different to 'a == b'
