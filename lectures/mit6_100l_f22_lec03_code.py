...
x = int(input('Please put in an integer that is greater than 0: '))
for i in range(1, x+1, 1):
    if i % 5 == 0:
        print(f'{i}')
...
n = int(input('Please put in an integer that is greater than 0: '))
sum = 0
while n > 0:
    sum += n % 10
    n //= 10
print(f'The sun of all digits in n is {sum}')
#########################################################
##################### END AT HOME ###########################
#########################################################
