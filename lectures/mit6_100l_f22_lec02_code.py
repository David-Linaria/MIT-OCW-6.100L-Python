...
# your code here
str = input('Please enter a verb: ')
print('I can', str, 'better than you.')
print(((str + ' ') * 5)[:len((str + ' ') * 5) - 1])
#########################################
...
# print("These are equal!") -> Indent this line
...
# your code here
secret = 31
guess = int(input('Please enter an integer you guess: '))
if guess == secret:
    print(f'You are right! The number is exactly {secret}')
elif guess < secret:
    print(f'Too small.')
else:
    print(f'Too large.')
